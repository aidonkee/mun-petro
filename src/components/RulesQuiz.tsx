...
const questions: Question[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Preambulatory clauses begin with italicized phrases (e.g., 'Recalling', 'Noting') and end with commas, while operative clauses use underlined phrases and end with semicolons.",
  },
  {
    id: 3,
    ...
    correctIndex: 0,
    explanation:
      "Most MUN conferences require at least 1 sponsor (the main author) for a working paper, though specific requirements may vary by conference.",
  },
  {
    id: 4,
    ...
    correctIndex: 1,
    explanation:
      "An unmoderated caucus allows delegates to leave their seats and engage in informal discussions to build consensus and draft resolutions.",
  },
  {
    id: 5,
    ...
    correctIndex: 2,
    explanation:
      "Yielding to the Chair means the delegate gives up any remaining speaking time, and the floor returns to the Chair.",
  },
];
      ...
      <div className="animate-fade-in max-w-2xl mx-auto">
        <div className="diplomatic-card-elevated p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            {percentage >= 80
              ? "Excellent work! You have a strong grasp of MUN rules."
              : percentage >= 60
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected && !hasAnswered && "quiz-option-selected",
